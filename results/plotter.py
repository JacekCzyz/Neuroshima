...
filename = 'reward_time_selfplay_500-000_dqn_same.csv'

average_rewards = []
game_results = []

# Mapowanie wyników gry na liczby
result_map = {
    "1won": 1,
    "2won": -1,
    "tie": 0
...
# Obliczanie średnich kroczących (10 ostatnich gier)
window_size = 100
moving_averages = []
...
# Przygotowanie danych do wykresu słupkowego – dzielenie na 5 segmentów
num_games = len(game_results)
segment_size = num_games // 5

# Zliczanie wyników w segmentach
...
for i in range(5):
    ...
    end = (i + 1) * segment_size if i < 4 else num_games  # ostatni segment do końca
...
# Wykres 1 – średnie kroczące nagród
plt.subplot(1, 2, 1)
...
# Wykres 2 – grupowany wykres słupkowy wyników
